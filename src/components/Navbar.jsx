...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white flex md:flex-col md:px-6 md:gap-8 md:h-screen justify-around border-t-2 py-2 md:border-none md:min-w-56">
      <NavLink to={"/"} className="hidden md:inline-block">
        <h2 className="text-4xl font-bold font-Oleo text-rose-700">
          ItsTheGram
        </h2>
      </NavLink>
      <NavLink to={"/"} className="flex">
        {({ isActive }) =>
          isActive ? (
            <div className="flex">
              <HiHome size={30} />
              <h2 className="text-2xl font-bold hidden md:inline-block md:ml-2">
                Home
              </h2>
            </div>
          ) : (
        ...
        {({ isActive }) =>
          isActive ? (
            ...
            <div className="flex">
              ...
              <h2 className="text-2xl hidden md:inline-block md:ml-2">
                Search
              </h2>
            </div>
          )
